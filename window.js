window.addEventListener('load',function (){
    ...
    class Background {
        constructor(game) {
            ...
            this.layers = [this.layer2, this.layer3,this.layer4];
        }
        update(){
        ...
        draw(context){
            ...
            if (this.game.gameOver){
               ...
               if (this.game.score > this.game.winningScore){
                   message1 = 'You win !';
                   message2 = 'Well done !';
                   showGameOverScreen('Green');
               } else{
                   message1 = 'You lose!';
                   message2 = 'Try again next time';
                   showGameOverScreen('Red');
               }
            ...
            //ammo
            if (this.game.player.powerUp) context.fillStyle = 'mffffbd';
...
// ascunde scena de joc la început
gameScene.style.display = 'none';

// afișează scena de start
startScene.style.display = 'flex';

// adaugă eveniment "click" la
startButton.addEventListener('click', function() {
    startScene.style.display = 'none'; // ascunde scena de start
    gameScene.style.display = 'block'; // afișează scena de joc
});
...
function showGameOverScreen(winner) {
    // Get the game over screen element and restart button element from the HTML document
    const gameOverScreen = document.getElementById('game-over-screen');
    const restartButton = document.getElementById('restart-button');
    ...
    // Add an event listener to the restart button that reloads the page when clicked
    restartButton.addEventListener('click', function() {
        location.reload();
    });
}